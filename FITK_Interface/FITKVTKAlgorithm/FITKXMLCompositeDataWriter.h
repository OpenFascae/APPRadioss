/*=========================================================================
  ...
  Program:   ParaView
  Module:    FITKXMLCompositeDataWriter.h
...
=========================================================================*/
/**
 * @class   FITKXMLCompositeDataWriter
 * @brief   Writer for multi-group datasets
 *
 * FITKXMLCompositeDataWriter writes (serially) the VTK XML multi-group,
...
#ifndef FITKXMLCompositeDataWriter_h
#define FITKXMLCompositeDataWriter_h
...
class FITKVTKALGORITHMAPI FITKXMLCompositeDataWriter : public vtkXMLWriter
{
public:
    vtkTypeMacro(FITKXMLCompositeDataWriter, vtkXMLWriter);
...
protected:
    ...
    ~FITKXMLCompositeDataWriter() override;
     ...
     * @date     2025-05-21
     */
    int GetFileTypeByPiece(int piece);
    ...
    FITKXMLCompositeDataWriterInternals* Internal;
...
private:
    FITKXMLCompositeDataWriter(const FITKXMLCompositeDataWriter&) = delete;
    void operator=(const FITKXMLCompositeDataWriter&) = delete;
};
