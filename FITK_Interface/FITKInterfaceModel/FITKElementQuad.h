/**
 *
 * @file FITKElementQuad.h
 * @brief 四边形单元声明
 * @author LiBaojun (libaojunqd@foxmail.com)
 * @date 2024-03-08
 *
 */
#ifndef _FITKELEMENT_QUADRANGLE_H__
#define _FITKELEMENT_QUADRANGLE_H__
...
namespace Interface
{
     ...
     * @date 2024-03-08
     */
    class FITKInerfaceModelAPI FITKElementQuad4 : public FITKAbstractElement
    {
    public:
        explicit FITKElementQuad4();
        virtual ~FITKElementQuad4() = default;
        /**
        * @brief 获取单元类型
        * @return FITKEleType
     ...
     * @date 2024-03-08
     */
    class FITKInerfaceModelAPI FITKElementQuad8 : public FITKAbstractElement
    {
    public:
        explicit FITKElementQuad8();
        virtual ~FITKElementQuad8() = default;
        /**
        * @brief 获取单元类型
        * @return FITKEleType
        * @author YanZhiHui (chanyuantiandao@126.com)
