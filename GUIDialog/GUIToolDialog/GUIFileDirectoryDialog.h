...
namespace GUI
{
    class GUIToolDialogAPI GUIFileDirectoryDialog : public GUIDialogBase
    {
        Q_OBJECT;
    public:
        /**
         ...
         * @since Version: 1.0.0
        **/
        GUIFileDirectoryDialog(Core::FITKActionOperator* oper, QWidget *parent = nullptr);
        /**
         * @brief 析构函数
         * @since Version: 1.0.0
        **/
        ~GUIFileDirectoryDialog();
