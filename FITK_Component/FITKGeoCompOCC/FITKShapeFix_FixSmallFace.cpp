...
IMPLEMENT_STANDARD_RTTIEXT(FITKShapeFix_FixSmallFace, ShapeFix_Root)

//#include <GeomLProp_SLProps.hxx>
//#include <TColStd_Array2OfReal.hxx>
//#include <TColStd_Array1OfReal.hxx>
FITKShapeFix_FixSmallFace::FITKShapeFix_FixSmallFace()
{
...
void FITKShapeFix_FixSmallFace::Init(const TopoDS_Shape& S)
{
    myShape = S;
    if (Context().IsNull())
...
void FITKShapeFix_FixSmallFace::SetPrecision(const Standard_Real preci)
{
    myAnalyzer.SetTolerance(preci);
    ShapeFix_Root::SetPrecision(preci);
}

void FITKShapeFix_FixSmallFace::Perform()
{
    FixSpotFace();
    FixStripFace();
}

void FITKShapeFix_FixSmallFace::Update()
{
    myShape = Context()->Apply(myShape);
    myResult = myShape;
}

TopoDS_Shape FITKShapeFix_FixSmallFace::FixSpotFace()
{
...
bool FITKShapeFix_FixSmallFace::FixSpotFace(TopoDS_Face face)
{
    // gp_Pnt spot;
// Standard_Real spotol;
    Standard_Boolean done = Standard_False;
...
Standard_Boolean FITKShapeFix_FixSmallFace::ReplaceVerticesInCaseOfSpot(TopoDS_Face& F, const Standard_Real /*tol*/) const
{
...
Standard_Boolean FITKShapeFix_FixSmallFace::RemoveFacesInCaseOfSpot(const TopoDS_Face& F) const
{
...
TopoDS_Shape FITKShapeFix_FixSmallFace::FixStripFace(const Standard_Boolean wasdone)
{
    if (myShape.IsNull()) return myShape;
    TopAbs_ShapeEnum st = myShape.ShapeType();
    // BRep_Builder theBuilder;
...
bool FITKShapeFix_FixSmallFace::FixStripFace(TopoDS_Face face)
{
    Standard_Boolean done = Standard_False;
...
Standard_Boolean FITKShapeFix_FixSmallFace::ReplaceInCaseOfStrip(TopoDS_Face& F, TopoDS_Edge& E1, TopoDS_Edge& E2, const Standard_Real tol) const
{
...
Standard_Boolean FITKShapeFix_FixSmallFace::RemoveFacesInCaseOfStrip(const TopoDS_Face& F) const
{
    Context()->Remove(F);
...
TopoDS_Edge FITKShapeFix_FixSmallFace::ComputeSharedEdgeForStripFace(const TopoDS_Face& /*F*/, const TopoDS_Edge& E1, const TopoDS_Edge& E2, const TopoDS_Face& F1, const Standard_Real tol) const
{
...
TopoDS_Shape FITKShapeFix_FixSmallFace::FixSplitFace(const TopoDS_Shape& /*S*/)
{
    if (myShape.IsNull()) return myShape;
    TopAbs_ShapeEnum st = myShape.ShapeType();
    Standard_Boolean done = Standard_False;
...
Standard_Boolean FITKShapeFix_FixSmallFace::SplitOneFace(TopoDS_Face& F, TopoDS_Compound& theSplittedFaces)
{
...
TopoDS_Face FITKShapeFix_FixSmallFace::FixFace(const TopoDS_Face& F)
{
    //smh#8
...
TopoDS_Shape FITKShapeFix_FixSmallFace::FixShape()
{
    TopoDS_Shape FixSh;
...
TopoDS_Shape FITKShapeFix_FixSmallFace::Shape()
{
    return myShape;
}

Standard_Boolean FITKShapeFix_FixSmallFace::FixPinFace(TopoDS_Face& /*F*/)
{
    return Standard_True;
}
